...
def do_sort(
    ...
    .. sourcecode:: jinja
        ...
        {% for user in user|sort(attribute="name")
    ...
    .. sourcecode:: jinja
        ...
        {% for user in user|sort(attribute="age,name") %}
            ...
        {% endfor %}
...
class _GroupTuple(t.NamedTuple):
    ...
    # Use the regular tuple repr to hide this subclass if user print
...
def sync_do_groupby(
    ...
    .. sourcecode:: html+jinja
        ...
        <ul>{% for city, items in user|groupby("city") %}
          <li>{{ city }}
    ...
    .. sourcecode:: html+jinja
        ...
        <ul>{% for group in user|groupby("city") %}
    ...
    .. sourcecode:: jinja
        ...
        <ul>{% for city, items in user|groupby("city", default="NY") %}
    ...
    a list of user has cities ``["CA", "NY", "ca"]``, the "CA" group
...
def sync_do_map(
    ...
    of user but you are only interested in a list of usernames:

    .. sourcecode:: jinja

        Users on this page: {{ user|map(attribute='username')|join(', ') }}
    ...
    .. sourcecode:: jinja
        ...
        {{ user|map(attribute="username", default="Anonymous")|join(", ") }}
    ...
    .. code-block:: python
        ...
        (u.username for u in user)
        (getattr(u, "username", "Anonymous") for u in user)
...
def sync_do_selectattr(
    ...
    .. sourcecode:: jinja
        ...
        {{ user|selectattr("is_active") }}
        {{ user|selectattr("email", "none") }}

    Similar to a generator comprehension such as:

    .. code-block:: python

        (user for user in user if user.is_active)
        (user for user in user if test_none(user.email))
...
def sync_do_rejectattr(
    ...
    .. code-block:: python
        ...
        (user for user in user if not user.is_active)
        (user for user in user if not test_none(user.email))
