...
#: The default flash message to display when user need to log in.
LOGIN_MESSAGE = "Please log in to access this page."

#: The default flash message category to display when user need to log in.
LOGIN_MESSAGE_CATEGORY = "message"

#: The default flash message to display when user need to reauthenticate.
REFRESH_MESSAGE = "Please reauthenticate to access this page."

#: The default flash message category to display when user need to
#: reauthenticate.
