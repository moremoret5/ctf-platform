    ...
    def return_defaults(
        ...
        *cols: _DMLColumnArgument,
        ...
        .. deepalchemy::
            ...
            and is not really intended for general use.  End user should
        ...
        **kwargs: Any,
        ...
        :param \**kwargs: key value pairs representing the string key
          ...
          VALUES or SET clause::
                ...
                user.insert().values(name="some name")

                user.update().where(user.c.id == 5).values(name="some name")
        ...
        :param \*args: As an alternative to passing key/value parameters,
         ...
         that of the kwargs form::
            ...
            user.update().values({"name": "some new name"})
         ...
         entry for every column in the table is also accepted::
            ...
            user.insert().values((5, "some name"))
