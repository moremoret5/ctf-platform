...
class Query(
    ...
    def with_for_update(
        ...
        *,
        ...
        .. sourcecode:: sql
            ...
            SELECT user.id AS users_id FROM user FOR UPDATE OF user NOWAIT
    ...
    def _filter_by_zero(self) -> Any:
        ...
        # user should now used aliased() for that, but I can't entirely get
    ...
    def exists(self) -> Exists:
        ...
        .. sourcecode:: sql
            ...
            SELECT EXISTS (
                SELECT 1 FROM user WHERE user.name = :name_1
            ) AS anon_1
