...
summary, Thick mode user should configure file locations and set the wallet
...
Thin mode user of mTLS should pass the appropriate directories and PEM wallet
...
Applications with multiple concurrent user should use connection pooling. A
